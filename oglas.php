...
<?php include('secondHeader.php')?>
    ...
    <div class="individualAdvertisement">
        <?php if($oglasBre): ?>
            ...
            <h2>godište: <?php echo htmlspecialchars($oglasBre['godiste']);?></h2>
            <h2>cena: <?php echo htmlspecialchars($oglasBre['price']);?> &euro;</h2>
        ...
        <h2><?php echo htmlspecialchars($oglasBre['price']);?></h2>
